...
The system uses the teensy's built-in LED because I did not have the right components, nor a multimeter to check the resistance of resistors I did have. This report will include a demonstration of how I would calculate the current-limiting resistor value for the LED to compensate.
...
vscode://file/{Project_media\Datasheets\MK20DX64VLH7_Datasheet.pdf} 
